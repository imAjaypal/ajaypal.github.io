...
<head>
    ...
    <?php define('site_key', '6LfEqOwpAAAAAFJjIpIjF4hho8Kvu09XDaZ0CX2d'); ?>
        ...
        <section class="py-5 container">
            <div class="row py-lg-5">
                <div class="col-lg-7 col-md-7 mx-auto">
                    ...
                    <p>
                        <a href="product.html" class="btn btn-primary my-2">Main call to action</a>
                        <a href="product.html" class="btn btn-secondary my-2">Secondary action</a>
                    </p>
                </div>
                <div class="col-lg-4 col-md-4 mx-auto">

                    <form id="recaptchaForm" class="" id="" action="" method="post">
                        <div class="mb-3">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-primary mb-3 g-recaptcha" data-sitekey="<?php echo site_key; ?>" data-callback='onSubmit' data-action='submit'>Submit</button>
                        </div>
                    </form>
